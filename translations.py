...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "welcome_choose_language": {
        "en": "🐋 <b>Welcome to Polymarket Whale Tracker!</b>\n\nPlease choose your language:",
        "uk": "🐋 <b>Ласкаво просимо до Polymarket Whale Tracker!</b>\n\nОберіть мову:",
        "ru": "🐋 <b>Добро пожаловать в Polymarket Whale Tracker!</b>\n\nВыберите язык:",
    },
    "welcome_main": {
        "en": (
            "🐋 <b>Polymarket Whale Tracker</b>\n\n"
            "I help you track whale wallets on Polymarket and notify you about their trades.\n\n"
            "🔔 <b>Features:</b>\n"
            "• Real-time trade notifications\n"
            "• View wallet positions & PnL\n"
            "• Track up to {limit} wallets\n\n"
            "Use the buttons below to get started! 👇"
        ),
        "uk": (
            "🐋 <b>Polymarket Whale Tracker</b>\n\n"
            "Я допомагаю відстежувати гаманці китів на Polymarket та сповіщати про їхні угоди.\n\n"
            "🔔 <b>Можливості:</b>\n"
            "• Сповіщення про угоди в реальному часі\n"
            "• Перегляд позицій та PnL гаманця\n"
            "• Відстеження до {limit} гаманців\n\n"
            "Використовуй кнопки нижче! 👇"
        ),
        "ru": (
            "🐋 <b>Polymarket Whale Tracker</b>\n\n"
            "Я помогаю отслеживать кошельки китов на Polymarket и уведомлять о их сделках.\n\n"
            "🔔 <b>Возможности:</b>\n"
            "• Уведомления о сделках в реальном времени\n"
            "• Просмотр позиций и PnL кошелька\n"
            "• Отслеживание до {limit} кошельков\n\n"
